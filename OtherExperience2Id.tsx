...
const OtherExperience2Id: React.FC = () => {
  ...
  const handleDisabledCareChange = (option: string) => {
    ...
    if (option === "Tidak") {
      updateFormData({ oe2DisabledCare: ["Tidak"] });
    } else {
  ...
  const handleResponsibilitiesChange = (option: string) => {
    ...
    if (option === "Tidak satupun dari berikut ini") {
        updateFormData({ oe2Responsibilities: ["Tidak satupun dari berikut ini"] });
    } else {
      ...
      <div className="max-w-3xl mx-auto flex flex-col gap-2">
        ...
        <div className="bg-red-100 p-4 rounded-lg mb-6 border-l-4 border-red-800">
          <h2 className="font-bold text-red-900 text-[20px] leading-tight">
            PRT Pengalaman Lainnya (2) (Termasuk Hong Kong, Negara Lain, Filipina, Indonesia, hanya PRT)
          </h2>
        </div>
          ...
          <div className="flex flex-col gap-3">
            {disabledOptions.map((option) => (
              <div key={option}>
                ...
                {formData.oe2DisabledCare?.includes(option) && option === "Penyandang disabilitas lainnya (1)" && (
                ...
                {formData.oe2DisabledCare?.includes(option) && option === "Penyandang disabilitas lainnya (2)" && (
                  <div className="mt-2 ml-4">
                     <Input 
                ...
                {formData.oe2DisabledCare?.includes(option) && option === "Penyandang disabilitas lainnya (3)" && (
                  <div className="mt-2 ml-4">
                     <Input 
          ...
          <div className="flex flex-col gap-3">
            {petOptions.map((option) => (
              <div key={option}>
                ...
                {formData.oe2Pets?.includes(option) && ["Anjing kecil", "Anjing sedang", "Anjing besar", "Kucing", "Kelinci"].includes(option) && (
                  <div className="mt-2 ml-4">
                     <Input 
                        type="number"
                        inputMode="numeric"
                ...
                {formData.oe2Pets?.includes(option) && option.toLowerCase().includes("peliharaan lain") && (
                   <div className="mt-2 ml-4 flex gap-2">
                    <input 
                      className="w-1/2 p-3 border-2 border-gray-300 rounded-lg text-[21px]"
                      placeholder="Tulis hewan peliharaan"
                      value={option === "Peliharaan lain (1)" ? (formData.oe2PetOtherName1 || '') : option === "Peliharaan lain (2)" ? (formData.oe2PetOtherName2 || '') : (formData.oe2PetOtherName3 || '')}
                      onChange={(e) => {
                         if (option === "Peliharaan lain (1)") updateFormData({ oe2PetOtherName1: e.target.value });
                         else if (option === "Peliharaan lain (2)") updateFormData({ oe2PetOtherName2: e.target.value });
                    ...
                    <input 
                      ...
                      className="w-1/2 p-3 border-2 border-gray-300 rounded-lg text-[21px]"
                      placeholder="Tuliskan jumlahnya"
                      value={option === "Peliharaan lain (1)" ? (formData.oe2PetOtherQty1 || '') : option === "Peliharaan lain (2)" ? (formData.oe2PetOtherQty2 || '') : (formData.oe2PetOtherQty3 || '')}
                      onChange={(e) => {
                         if (option === "Peliharaan lain (1)") updateFormData({ oe2PetOtherQty1: e.target.value });
                         else if (option === "Peliharaan lain (2)") updateFormData({ oe2PetOtherQty2: e.target.value });
          ...
          <div className="flex flex-col gap-3">
            {respOptions.map((option) => (
              <div key={option}>
                ...
                {formData.oe2Responsibilities?.includes(option) && option === "Tanggung jawab lainnya (1)" && (
                  <div className="mt-2 ml-4">
                     <Input 
                ...
                {formData.oe2Responsibilities?.includes(option) && option === "Tanggung jawab lainnya (2)" && (
                  <div className="mt-2 ml-4">
                     <Input 
                ...
                {formData.oe2Responsibilities?.includes(option) && option === "Tanggung jawab lainnya (3)" && (
                  <div className="mt-2 ml-4">
                     <Input 
        ...
        <RadioGroup
          ...
          options={[
            ...
            "Tidak, hanya 2 pengalaman majikan"
          ]}
...
export default OtherExperience2Id;